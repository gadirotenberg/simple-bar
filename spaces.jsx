...
const render = ({ output, error }) => {
  ...
  const { displays, shadow, SIP, spaces, windows, recentSpace } = data
  ...
  return (
    <div className={classes}>
      <Spaces.Component spaces={spaces} windows={windows} SIP={SIP} displayIndex={displayIndex} recentSpace={recentSpace} />
